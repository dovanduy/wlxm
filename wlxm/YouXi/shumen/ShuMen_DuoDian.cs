...
namespace fuzhu
{
    public class ShuMen_DuoDian
    {
        #region 单例模式变量
        private static readonly object obj = new object();
        private static ShuMen_DuoDian yqdd = null;
        #endregion
        private ShuMen_DuoDian() {
        ...
        {
            get { return ShuMen_DuoDian._list_zuobiao; }
            set { ShuMen_DuoDian._list_zuobiao = value; }
        }
        ...
        {
            get { return ShuMen_DuoDian._list_yqduodian; }
            set { ShuMen_DuoDian._list_yqduodian = value; }
        }
        ...
        {
            get { return ShuMen_DuoDian._list_yqfhduodian; }
            set { ShuMen_DuoDian._list_yqfhduodian = value; }
        }


        static ShuMen_DuoDian()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public static ShuMen_DuoDian GetObject()
        {
            if (yqdd == null)
            {
                lock (obj)
