...
namespace fuzhu
{
    public class YiQuanZhiTuo_DuoDian
    {
        #region 单例模式变量
        private static readonly object obj = new object();
        private static YiQuanZhiTuo_DuoDian yqdd = null;
        #endregion
        private YiQuanZhiTuo_DuoDian() {
        ...
        {
            get { return YiQuanZhiTuo_DuoDian._list_zuobiao; }
            set { YiQuanZhiTuo_DuoDian._list_zuobiao = value; }
        }
        ...
        {
            get { return YiQuanZhiTuo_DuoDian._list_yqduodian; }
            set { YiQuanZhiTuo_DuoDian._list_yqduodian = value; }
        }
        ...
        {
            get { return YiQuanZhiTuo_DuoDian._list_yqfhduodian; }
            set { YiQuanZhiTuo_DuoDian._list_yqfhduodian = value; }
        }
        


        static YiQuanZhiTuo_DuoDian()
        {
            ...
            FuHeDuoDian fh3 = new FuHeDuoDian("红色拳头", dz3, -1, -1, ls0);
            _list_yqduodian.Add(dz3);
            _list_yqfhduodian.Add(fh3);

            dz3 = new DuoDianZhaoSe(0x9fd475, "2|0|0x9dd174,9|0|0xa1d576,13|0|0xa1d676,13|3|0xa1d676,66|1|0x7cd30a", 90, 3, 106, 105, 156);
             fh3 = new FuHeDuoDian("日常完成", dz3, -1, -1, ls0);
            _list_yqduodian.Add(dz3);
            _list_yqfhduodian.Add(fh3);
            ...
            rcdz5 = new DuoDianZhaoSe(0xe14d4d, "0|1|0xe54848,0|2|0xe54848,0|3|0xe54848,0|4|0xe54848", 90, 249, 37, 249, 274);
             rcfh5 = new FuHeDuoDian("新人手册", rcdz5, -1, -1);
            _list_yqduodian.Add(rcdz5);
            _list_yqfhduodian.Add(rcfh5);
        ...
        /// </summary>
        /// <returns></returns>
        public static YiQuanZhiTuo_DuoDian GetObject()
        {
            if (yqdd == null)
            {
                lock (obj)
